...
public class GptService {
    ...
    public String generateResponse(String inputJson, String inputText) {
        String prompt = String.format("""
            ...
            6.  value에 대응되는 값이 없는 key의 value를 빈문자열로 ("") 로 수정하세요.
            ...
            3.  출장금액은 식비정산금, 숙박비금액, 금액을 모두 더하세요.
            4.  식사제공횟수는 식비와 관련된 영수증의 개수로 채우세요.
            5.  교툥편은 "버스", "기차", "비행기"의 값으로만 채우세요. 구분도 같은 값으로 채우세요.
            6.  **JSON 구조 변경 금지:** JSON의 키(key) 이름, 객체 구조, 배열 순서 등을 절대 변경하지 마세요.
            7.  **대화 금지:** 응답은 오직 채워진 JSON 데이터여야 합니다. 어떠한 형태의 대화나 설명도 포함하지 마세요.
